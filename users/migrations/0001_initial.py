    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrator'), ('staff', 'Staff'), ('farmer', 'Farmer')], default='farmer', max_length=10)),
                ...
                ('crops', models.TextField(blank=True, help_text='Types of crops grown', null=True)),
